...
**NOTE:** To use Agile in your springboot-sample project you can start following the instruction directly from section **Creating a Project and Some Issues**, ***point 6*** `6. Once project provisioning is completed, you are automatically taken to your new project’s Project page. Click the Issues tab.`. Apply Agile instruction (names of issues, tasks etc.) to match your springboot-sample project.
