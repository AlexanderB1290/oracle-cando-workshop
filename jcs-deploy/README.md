...
#####  *Optional Alternative for Building the sample application*#####
Alternatively, you can create, modify and build your app in Eclipse, as well as you can build and deploy your app by using the Oracle Developer Cloud Service (DevCS), with the help of this tutorial 
[Developing Applications with Eclipse and Oracle Developer Cloud Service](http://www.oracle.com/webfolder/technetwork/tutorials/obe/cloud/developer/UsingODCSwithOEPE/UsingODCSwithOEPE.html) , as instead of using the sample Eclipse and DevCS projects provided in the tutorial you shall consider and create:
- your own Elcipse Java EE project by using the source code located in the  `GIT_REPO_LOCAL_CLONE/techco-app` folder
- your own DevCS project (for example `techco-app` project) based on Initial Repository
